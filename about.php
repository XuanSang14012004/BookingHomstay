...
<body>
  ...
  <section class="about">
    <h2>Về Chúng Tôi</h2>
    <p><strong>Booking Homestay</strong> là nền tảng đặt phòng homestay trực tuyến,
      giúp bạn kết nối với những không gian nghỉ dưỡng độc đáo, thoải mái và đáng nhớ
      trên khắp Việt Nam.</p>
    ...
    <div class="team">
      ...
      <div class="team-members">
        ...
        <div class="member">
          <img src="" alt="Thành viên 2">
          <h4>Trần Thị B</h4>
          <p>Marketing</p>
        </div>
        <div class="member">
          <img src="" alt="Thành viên 3">
          <h4>Lê Văn C</h4>
          <p>Developer</p>
        </div>
        <div class="team-members">
