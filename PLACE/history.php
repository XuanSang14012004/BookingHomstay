            ...
            <div class="history-list-area">
                ...
                <div class="history-card <?php echo strtolower(str_replace(' ', '-', $row['status'])); ?>"
                    ...
                    <div class="history-card-thumb">
                        <img src="/BS/FE/images/<?php echo htmlspecialchars($row['homestay_img']); ?>"
