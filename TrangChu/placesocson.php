...
<body>
    ...
    <div class="room-list" id="roomList">
      ...
      <div class="card" data-type="Deluxe" data-stars="5">
        ...
        <div class="card-content">
          ...
          <div class="stars">⭐⭐⭐⭐⭐</div>
          <div class="btn-group">
            <a href="amayahomedeluxe.php" class="btn-place btn-detail">Xem chi tiết</a>
      ...
      <div class="card" data-type="Deluxe" data-stars="5">
        ...
        <div class="card-content">
          ...
          <div class="stars">⭐⭐⭐⭐⭐</div>
          <div class="btn-group">
            <a href="CerfVolantSocSonResortdeluxe.php" class="btn-place btn-detail">Xem chi tiết</a>
            <a href="#" class="btn-place btn-book">Đặt phòng</a>
          </div>
        </div>
      </div>
 ...
 <div class="card" data-type="Deluxe" data-stars="5">
        ...
        <div class="card-content">
          ...
          <div class="stars">⭐⭐⭐⭐⭐</div>
          <div class="btn-group">
            <a href="De'bayRetreatdeluxe.php" class="btn-place btn-detail">Xem chi tiết</a>
            <a href="#" class="btn-place btn-book">Đặt phòng</a>
          </div>
        </div>
      </div>
      ...
      <div class="card" data-type="Family" data-stars="4">
        ...
        <div class="card-content">
          ...
          <div class="stars">⭐⭐⭐⭐</div>
          <div class="btn-group">
            <a href="Amaya Retreat-family.php" class="btn-place btn-detail">Xem chi tiết</a>
            <a href="#" class="btn-place btn-book">Đặt phòng</a>
          </div>
        </div>
      </div>
 ...
 <div class="card" data-type="Family" data-stars="4">
        ...
        <div class="card-content">
          ...
          <div class="stars">⭐⭐⭐⭐</div>
          <div class="btn-group">
            <a href="amayahomefamily.php" class="btn-place btn-detail">Xem chi tiết</a>
            <a href="#" class="btn-place btn-book">Đặt phòng</a>
          </div>
        </div>
      </div>
      ...
      <div class="card" data-type="Standard" data-stars="3">
        ...
        <div class="card-content">
          ...
          <div class="stars">⭐⭐⭐</div>
          <div class="btn-group">
            <a href="CerfVolantSocSonResortstandard.php" class="btn-place btn-detail">Xem chi tiết</a>
            <a href="#" class="btn-place btn-book">Đặt phòng</a>
          </div>
        </div>
      </div>
...
<div class="card" data-type="Standard" data-stars="3">
        ...
        <div class="card-content">
          ...
          <div class="stars">⭐⭐⭐</div>
          <div class="btn-group">
            <a href="De'bayRetreatstandrad.php" class="btn-place btn-detail">Xem chi tiết</a>
            <a href="#" class="btn-place btn-book">Đặt phòng</a>
          </div>
        </div>
      </div>
      ...
      <div class="card" data-type="Standard" data-stars="3">
        ...
        <div class="card-content">
          ...
          <div class="stars">⭐⭐⭐</div>
          <div class="btn-group">
            <a href="Amaya Retreat-standard.php" class="btn-place btn-detail">Xem chi tiết</a>
            <a href="#" class="btn-place btn-book">Đặt phòng</a>
          </div>
        </div>
      </div>
