...
<body>
    ...
    <div class="header-top">
        <ul>
            <li><a href="user_dashboard.php">Trang chủ</a></li>
            <li><a href="about_us.php">Về chúng tôi</a></li>
            <li><a href="contact.php">Liên hệ</a></li>
            <li><a href="feedback.php">Đánh giá</a></li>
            <li><a href="homestay_list">Danh sách các HomeStay</a></li>
             <li><a href="../login/login.php">Đăng nhập</a></li>
             <li><a href="user_account.php"><i class="fa-solid fa-user"></i></a></li>
        </ul>
    </div>
            ...
            <div class="nice-place-content row">
                <div class="nice-place-item">
                    <div class="nice-place-img">
                        <img src="../../images/1.jpg" alt="Amaya Home">
                    </div>
                ...
                <div class="nice-place-item">
                    <div class="nice-place-img">
                        <img src="../../images/2.jpg" alt="Cerf Volant Accommodation & Event">
                    </div>
                    <div class="nice-place-text">
                   ...
                   <div class="nice-place-item">
                    <div class="nice-place-img">
                        <img src="../../images/3.jpg" alt="De’bay Villa Sóc Sơn">
                    </div>
                    <div class="nice-place-text">
                   ...
                   <div class="nice-place-item">
                    <div class="nice-place-img">
                        <img src="../../images/4.jpg" alt="Amaya Retreat Sóc Sơn">
                    </div>
                    <div class="nice-place-text">
...
<section class="blog">
  <div class="container">
    ...
    <div class="blog-list">
      ...
      <!-- Bài viết 1 -->
      <div class="blog-card">
  <img src="../../images/BV.jpg" alt="Kinh nghiệm du lịch Đà Lạt">
        <div class="blog-info">
      ...
      <!-- Bài viết 2 -->
      <div class="blog-card">
  <img src="../../images/3.jpg" alt="Mẹo đặt homestay giá rẻ">
        <div class="blog-info">
      ...
      <!-- Bài viết 3 -->
      <div class="blog-card">
  <img src="../../images/3.jpg" alt="Khám phá Sapa">
        <div class="blog-info">
