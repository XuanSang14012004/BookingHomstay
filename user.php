    ...
    <section>
        <form action="" class="form-list">
            ...
            <datalist id="lstClasses">
                <option value="Amaya Home">Sóc Sơn</option>
                <option value="Cerf Volant Accommodation & Event">Sóc Sơn</option>
                <option value="De’bay Villa Sóc Sơn">Sóc Sơn</option>
                 <option value="Amaya Retreat Sóc Sơn">Sóc Sơn</option>
            </datalist>
            </td>
             </tr>
             <tr>
...
<section class="explore-location">
  ...
  <div class="location-grid">
    ...
    <div class="location-item">
      <img src="ANH/2.jpg" alt="Hồ Gươm">
      <div class="overlay">Hoàn Kiếm
      <button class="btn">Xem chi tiết</button>
    </div>
    </div>
    <div class="location-item">
      <img src="ANH/3.jpg" alt="Hồ Tây">
      <div class="overlay">Hồ Tây
      <button class="btn">Xem chi tiết</button>
    </div>
    </div>
    <div class="location-item">
      <img src="ANH/4.jpg" alt="Ba Vì">
     ...
     <div class="location-item">
      <img src="ANH/4.jpg" alt="Ba Vì">
      <div class="overlay">Hai Bà Trưng
      <button class="btn">Xem chi tiết</button>    
    </div>
     </div>
    <div class="location-item">
      <img src="ANH/4.jpg" alt="Ba Vì">
      <div class="overlay">Ba Đình
      <button class="btn">Xem chi tiết</button>
    </div>
    </div>
    <div class="location-item">
      <img src="ANH/4.jpg" alt="Ba Vì">
      <div class="overlay">Đống Đa
      <button class="btn">Xem chi tiết</button>
    </div>
    </div>
    <div class="location-item">
      <img src="ANH/4.jpg" alt="Ba Vì">
      <div class="overlay">Cầu Giấy
      <button class="btn">Xem chi tiết</button>
    </div>
    </div>
  </div>
