...
$total_result = $conn->query("SELECT COUNT(*) as total FROM db_owner");
                ...
                <tbody>
                    <tr>
                        ...
                        if( isset($_GET['content']) ? $_GET['content'] :'' ){
                            ...
                            $sql = "SELECT * FROM db_owner WHERE owner_id LIKE '$search'
        ...
        <form action="../modules/add_function.php" method="POST">
            <div class="form-section">
                ...
                <div class="form-group">
                    <label for="customer_id">Mã tài khoản:</label>
