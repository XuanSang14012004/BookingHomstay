...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 25, 2025 lúc 07:02 AM
...
CREATE TABLE `db_booking` (
  ...
  `mahomestay` varchar(255) NOT NULL,
...
INSERT INTO `db_booking` (`madondatphong`, `makhachhang`, `tenkhachhang`, `mahomestay`, `maphong`, `ngaydatphong`, `ngaynhanphong`, `ngaytraphong`, `songuoi`, `tongtien`, `trangthai`, `chuthich`) VALUES
...
--
-- Cấu trúc bảng cho bảng `db_danhgia`
--
...
--
-- Đang đổ dữ liệu cho bảng `db_danhgia`
--
...
INSERT INTO `db_homestay` (`mahomestay`, `tenhomestay`, `loaihinh`, `trangthai`, `mota`, `sophong`, `tiennghi`, `diachi`, `sodienthoai`, `email`, `giathue`, `chinhsach`, `hinhanh`, `diemdanhgia`, `soluotdanhgia`) VALUES
...
--
-- Cấu trúc bảng cho bảng `db_phong`
--
...
--
-- Đang đổ dữ liệu cho bảng `db_phong`
--
...
--
-- Cấu trúc bảng cho bảng `db_thanhtoan`
--
...
--
-- Đang đổ dữ liệu cho bảng `db_thanhtoan`
--
...
--
-- Chỉ mục cho bảng `db_phong`
--
ALTER TABLE `db_phong`
  ADD PRIMARY KEY (`maphong`);

--
-- Chỉ mục cho bảng `db_thanhtoan`
--
